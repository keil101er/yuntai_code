...
extern void gimbal_behaviour_mode_set(gimbal_control_t *gimbal_mode_set,c_fbpara_t *motor);
...
/**
  ...
  * @retval         none
  */
extern void gimbal_behaviour_control_set(fp32 *add_yaw, fp32 *add_pitch, gimbal_control_t *gimbal_control_set,c_fbpara_t *C_data);
