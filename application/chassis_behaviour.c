...
/**
  ...
  * @retval         返回空
  */
static void chassis_no_m ove_control(fp32 *vx_set, fp32 *vy_set, fp32 *wz_set, chassis_move_t *chassis_move_rc_to_vector);
...
//    // 先检查 R 键是否按下
//    if (chassis_move_control->chassis_RC->key.v & KEY_PRESSED_OFFSET_R)
//   {
...
//   }
    ...
    {
		 chassis_behaviour_mode = CHASSIS_NO_MOVE;
//        chassis_behaviour_mode = CHASSIS_NO_FOLLOW_YAW;//CHASSIS_NO_FOLLOW_YAW 小陀螺
		// chassis_behaviour_mode = CHASSIS_INFANTRY_FOLLOW_GIMBAL_YAW;
    }
