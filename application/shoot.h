...
//拨弹速度
#define TRIGGER_SPEED               (17.0f)
#define CONTINUE_TRIGGER_SPEED      (17.0f)
#define READY_TRIGGER_SPEED         (17.0f)


//子弹速度
#define BULLET_SPEED         (19.5f)
...
#define FRIC_SPEED_PID_KP        2500.0f
#define FRIC_SPEED_PID_KI        4.0f
#define FRIC_SPEED_PID_KD        0.0f
#define FRIC_PID_MAX_OUT         8000.0f
#define FRIC_PID_MAX_IOUT        100.0f
...
typedef struct
{
    ...
    const motor_measure_t *shoot_motor_measure;
	  const motor_measure_t *fricL_motor_measure;
    const motor_measure_t *fricR_motor_measure;
...
//    uint16_t fric_pwm2;
    ...
    pid_type_def fric_motor_R_pid;
	  pid_type_def self_explosion_pid;
    ...
    int16_t fric_r_current;
    int8_t ecd_count;
	uint8_t fric_enabled;     //摩擦轮开启判断
    uint8_t last_key;
