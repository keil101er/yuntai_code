...
#define PITCH_SPEED_PID_KP        0.8f
#define PITCH_SPEED_PID_KI        0.000f
#define PITCH_SPEED_PID_KD        0.000f
#define PITCH_SPEED_PID_MAX_OUT   5.0f
...
#define PITCH_STATIC_FF_GYRO_SET_THRESHOLD 0.02f
#define PITCH_STATIC_FF_FULL_GYRO          0.2f
#define PITCH_STATIC_FF_HOLD               -0.65f
#define PITCH_STATIC_FF_POS                0.3f
#define PITCH_STATIC_FF_NEG                -1.6f
...
#define YAW_AUTO_SPEED_PID_KP        2.0f
...
#define YAW_AUTO_LOW_ABSOLUTE_PID_KP       19.0f
